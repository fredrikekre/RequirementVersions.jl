...

{
    ...
    "category": "Method",
    "text": "minimum_requirement_versions(package_name; package_directory = Pkg.dir(), skips = String[])\n\nAutomatically finds the minimum versions of required packages that will still allow your tests to pass. List any packages you want to skip in skips.\n\nMakes the assumption that if a certain profile of versions work, all profiles with versions greater or equal will also work.\n\n\n\n"
},
